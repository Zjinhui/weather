package com.huiview.weather.activity;
...
import com.huiview.weather.R;
import com.huiview.weather.db.WeatherDB;
import com.huiview.weather.model.City;
import com.huiview.weather.model.County;
import com.huiview.weather.model.Province;
import com.huiview.weather.util.HttpCallbackListener;
import com.huiview.weather.util.HttpUtil;
import com.huiview.weather.util.Utility;
...
public class ChooseAreaActivity extends Activity {
    ...
    /**
     * 查询选中省内部所有的市，优先从数据库查询，如果没有查询到再去服务器查询
     */
...
;                }
    ...
    /**
     * 捕获Back按键，根据当前的级别来半段，此时应该返回是列表，省列表，还是直接退出
     */
    @Override
